...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Flipper-DoubleConversion/DoubleConversion.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Flipper-Glog/glog.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-bringg-driver-sdk/react_native_bringg_driver_sdk.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-maps/react_native_maps.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/BringgDriverSDKObjc/BringgDriverSDKObjc.framework"
