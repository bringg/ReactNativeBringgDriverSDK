...
exports.waypointFromJSONObject = waypointFromJSONObject;
exports.PickupDropoffOption = exports.AddressType = void 0;
...
let PickupDropoffOption;
exports.PickupDropoffOption = PickupDropoffOption;
...
function waypointFromJSONObject(jsonObject) {
  ...
  dateKeys.forEach(key => {
    waypoint[key] = (0, _parseISODate.parseISODateString)(waypoint[key]);
  });
  return waypoint;
}
